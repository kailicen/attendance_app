...
def create_admin():
    ...
    admin = User(if_admin=True, if_member=False, name='Admin', email='vppr-6247@toastmastersclubs.org',
...
def init_member():
    ...
    names = ["Rebecca Lyons", "Edwin Quilliam", "Mark Zeeman", "Karina Skegg", "Regina Xiao Qi Chan",
             ...
             "Tony Quang Nguyen", "Acacia Scott Clark", "Stuart Campbell", "Gemma Campbell", "John Lee", "Phoenix Harrison"]
    emails = ["moonchild7901@hotmail.com", "fern005@live.com.au", "mzeeman1@bigpond.com", "kombiwomble@gmail.com",
              ...
              "gemmacampbell94@outlook.com", "john.d.lee@outlook.com", "phoenixharrison728@gmail.com"]
    mobiles = ["0417 307 658", "0400 254 836", "0477 786 975", "0409 236 243", "0452 505 269", "0411 170 189",
               ...
               "0452 399 187", "0433 882 833", "0405 997 655", "0452 380 168", "0488 188 846", "0456 764 608", "0404 608 825", "0400 740 499", "0409 519 550"]
    for i in range(0, 29):
    ...
    # guests by 9/8/2021
    names = ["Adithya Rajan", "Zona", "Ming", "Dennis",
             "Molly Kendall", "Danielle Stokes", "David"]
    emails = ["adithyarranjith@gmail.com", "zona0120@gmail.com", "tomorrowmmm@gmail.com",
              "dennissally1314@gmail.com", "mollycuddle@hotmail.com", "dtas2@bigpond.com", "dzheng0@utas.edu.au"]
    mobiles = ["0406 591 514", "0423 063 643", "0424 163 336",
               "0402 064 889", "0422 938 967", "0409 562 605", "0483 056 646"]
    for i in range(0, 7):
        user = User(if_member=False,
                    name=names[i], email=emails[i], mobile=mobiles[i])
        db.session.add(user)
        db.session.commit()
